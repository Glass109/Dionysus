    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
            <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                ...
                <p class="text-sm">Procede con cuidado, esto no se puede deshacer.</p>
            </div>
            <Dialog>
                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Una vez que tu cuenta sea eliminada, todos sus recursos y datos también se eliminarán permanentemente. Por favor, introduce tu contraseña para confirmar que deseas eliminar permanentemente tu cuenta.
                            </DialogDescription>
                        </DialogHeader>
